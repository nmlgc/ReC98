...
loc_D04F:
		mov	word ptr dword_23F52, 80h ; 'А'
		mov	word ptr dword_23F52+2,	80h ; 'А'
...
arg_0		= word ptr  4
		...
		mov	di, [bp+arg_0]
		shl	di, 7
		mov	word ptr [bp+var_6+2], 80h ; 'А'

loc_DFD8:
		mov	word ptr [bp+var_6], 80h ; 'А'
		mov	[bp+var_2], 18h
...
loc_10461:
		push	large 3E000Dh
		push	ds
		push	offset aB@b@bB@b@ ; "Б@Б@Б~Б@Б@"
		push	0E1h ; 'с'
		call	text_putsa
		cmp	[bp+var_1], 0Ah
		jl	short loc_104A2
...
loc_10514:
		...
		push	large 3E000Bh
		push	ds
		push	offset aB@b@bB@b@_0 ; "Б@Б@Б~Б@Б@"
		push	0E1h ; 'с'
		call	text_putsa
		cmp	[bp+var_1], 0Ah
		jl	short loc_1055B
...
loc_12A6A:
		...
		cmp	byte ptr [bp-1], 2
		jnz	short loc_12A7D
		sub	word ptr [si+2], 80h ; 'А'
		jmp	short loc_12A82
; ---------------------------------------------------------------------------

loc_12A7D:
		add	word ptr [si+2], 80h ; 'А'
...
unk_222A0	db  4Dh	; M
		...
		db    0
a_Abcd		db '\]^_`abcd',0
aBOSS_FINAL_TIMEOUT	db 'ИлЧьГ{ГXС▐ОбО╕ФsБIБIБ@Б@Б@Б@Б@Б@Б@Б~Б@ВOБDВO',0
aPENALTY_6	db 'ГvГМГCГДБ[РФГyГiГЛГeГBБiПЙК·ВUРlБjБ~Б@ВOБDВR',0
aPENALTY_5	db 'ГvГМГCГДБ[РФГyГiГЛГeГBБiПЙК·ВTРlБjБ~Б@ВOБDВT',0
aPENALTY_4	db 'ГvГМГCГДБ[РФГyГiГЛГeГBБiПЙК·ВSРlБjБ~Б@ВOБDВV',0
aPENALTY_CONT_1	db 'ГRГУГeГBГjГЕБ[ГyГiГЛГeГBБiВPЙёБjБ@Б~Б@ВOБDВW',0
aPENALTY_CONT_2	db 'ГRГУГeГBГjГЕБ[ГyГiГЛГeГBБiВQЙёБjБ@Б~Б@ВOБDВU',0
aPENALTY_CONT_3	db 'ГRГУГeГBГjГЕБ[ГyГiГЛГeГBБiВRЙёБjБ@Б~Б@ВOБDВS',0
aBONUS_EASY	db 'УяИ╒УxГ{Б[ГiГXБiВdВБВУВЩБjБ@Б@Б@Б@Б~Б@ВOБDВT',0
aBONUS_NORMAL	db 'УяИ╒УxГ{Б[ГiГXБiВmВПВТВНВБВМБjБ@Б@Б~Б@ВPБDВO',0
aBONUS_HARD	db 'УяИ╒УxГ{Б[ГiГXБiВgВБВТВДБjБ@Б@Б@Б@Б~Б@ВPБDВQ',0
aBONUS_LUNATIC	db 'УяИ╒УxГ{Б[ГiГXБiВkВХВОВБВФВЙВГБjБ@Б~Б@ВPБDВS',0
aBONUS_STAGE	db 'ВrВsВ`ВfВdБ@ВaВПВОВХВУ',0
aBONUS_DREAM	db 'ВcВqВdВ`ВlБ@ВaВПВОВХВУ',0
aGRAZEX50	db 'ГJГXГКТeРФБ@Б~Б@Б@ВTВO',0
aPOINT_ITEMS	db 'Б@Б~Б@У╛У_ГAГCГeГАРФБ@',0
aBONUS_NOMISS	db 'Б@Б{Б@ГmБ[Г~ГXГ{Б[ГiГX',0
aBONUS_NOBOMB	db 'Б@Б{Б@ГmБ[Г{ГАГ{Б[ГiГX',0
aBONUS_TOTAL	db 'Б@Б@Б@ВsВnВsВ`Вk',0
aALL_CLEAR	db 'В`ВkВkБ@ВbВМВЕВБВТБ@Б@',0
aPLAYER_REM	db 'ОcВшРlРФБ@Б~ВPВOВOВOВO',0
aPOINT_TOTAL	db 'СНУ╛У_ГAГCГeГАГ{Б[ГiГX',0
word_22582	dw 200h
					; sub_16BD9+C9r ...
word_22584	dw 1600h
					; sub_16BD9+D7r ...
...
byte_22741	db 0E1h
aB@b@bB@b@	db 'Б@Б@Б~Б@Б@',0
aB@b@bB@b@_0	db 'Б@Б@Б~Б@Б@',0
		db 0BBh	; ╗
		db  2Fh	; /
		db 0F6h	; Ў
		db  2Fh	; /
...
aTH05_10	db 'Р^НgВ╠ПнПЧБ@Б` Crimson Dead!!',0
a_dm08_tx2	db '_DM08.TX2',0
aTH05_11	db 'ЧаР╪ВшВ╠ПнПЧБ@Б` Judas Kiss',0
		db 0D7h	; ╫
		db  62h	; b
		db 0A8h	; и
		db  63h	; c
