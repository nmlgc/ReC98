...
word_36D	dw 1234h
		db 50h,	0Eh, 0E8h, 0BAh, 26h, 7, 1Fh, 72h, 6, 4Dh, 74h
		db 1Fh,	0E9h, 69h, 0FFh, 1Eh, 2Eh, 8Eh,	1Eh, 5Fh, 3, 8Bh
		db 0C8h, 6, 0Eh, 0E8h, 0A7h, 20h, 0Eh, 0E8h, 0A3h, 20h
		db 8Bh,	0C1h, 0F9h, 5Eh, 5Fh, 1Fh, 5Dh,	0CAh, 8, 0, 90h
		db 1Eh,	2Eh, 8Eh, 1Eh, 5Fh, 3, 6, 0Eh, 0E8h, 8Dh, 20h
		db 0Eh,	0E8h, 89h, 20h,	0B8h, 2	dup(0),	0F8h, 5Eh, 5Fh
		db 1Fh,	5Dh, 0CAh, 8, 0
...
loc_627:
		add	word_20DCC, 6
		cmp	word_20DCC, 64h	; 'd'
		jl	short loc_613
		mov	word_20DCC, 64h	; 'd'
		nop
		push	cs
		call	loc_2158
		pop	di
...
loc_2A1A:
		...
		pop	ax
		jmp	short loc_2A27
; END OF FUNCTION CHUNK	FOR sub_2A2E
; ---------------------------------------------------------------------------
		nop
; START	OF FUNCTION CHUNK FOR sub_2A2E
...
; FUNCTION CHUNK AT 2A1A SIZE 00000009 BYTES
; FUNCTION CHUNK AT 2A24 SIZE 0000000A BYTES
...
loc_2CE2:
		...
		cmp	ax, word_210D0
		jnb	short loc_2CFD
		cmp	word ptr [bx+2A9Eh], 0
		jz	short loc_2D01
		push	word ptr [bx+269Eh]
		push	cs
		call	near ptr sub_291E
		jmp	short loc_2D01
; ---------------------------------------------------------------------------
...
arg_4		= word ptr  0Ah
		...
		mov	ax, word_21190
		imul	bx, ax,	16h
		cmp	word ptr [bx+2FB6h], 1
		jnz	short loc_3B3C
		cmp	word ptr [bx+2FBAh], 1
		jz	short loc_3B3C
		cmp	word ptr [bx+2FB2h], 20h ; ' '
		jz	short loc_3B3C
		mov	si, 1
		jmp	short loc_3B3E
; ---------------------------------------------------------------------------
...
loc_3B4E:
		imul	bx, cx,	16h
		cmp	byte ptr [bx+2FAEh], 48h ; 'H'
		jz	short loc_3B5C
		or	si, si
		jz	short loc_3B78

loc_3B5C:
		cmp	byte ptr [bx+2FC4h], 48h ; 'H'
		jz	short loc_3B6A
		cmp	word ptr [bx+2FCCh], 1
		jg	short loc_3BA4

loc_3B6A:
		cmp	byte ptr [bx+2FDAh], 48h ; 'H'
		jz	short loc_3B78
		cmp	word ptr [bx+2FE2h], 1
		jg	short loc_3BB8
...
loc_3BC0:
		imul	bx, word_21190,	16h
		dec	word ptr [bx+2FB6h]
		jnz	short loc_3BE4
		add	bx, 2FA6h
		push	bx
		nop
		push	cs
		call	near ptr sub_36E8
		or	ax, ax
		jnz	short loc_3BE4
		mov	cl, byte ptr word_21190
		inc	ax
		shl	ax, cl
		or	word_21192, ax
...
; ---------------------------------------------------------------------------
		...
		cmp	byte_22F05, 0
		jnz	short loc_59E2
		mov	word_2D114, seg	seg000
		mov	word_2D112, 59C2h
		mov	byte_22F05, 1

loc_59E2:
		push	word ptr [bp+6]
		push	cs
		call	near ptr sub_599D
		pop	cx
		mov	[bp-2],	ax
		cmp	ax, 0FFFFh
		jnz	short loc_5A01
...
loc_5B0E:
		...
		mov	cl, 2
		shl	bx, cl
		mov	word ptr [bx+2528h], 0
		mov	word ptr [bx+2526h], 0
		mov	bx, [bp+var_2]
		mov	al, [bx+2544h]
		mov	ah, 0
		push	ax
...
sub_106F3	proc far
		...
		ja	short loc_10796
		add	bx, bx
		jmp	word ptr cs:(loc_83C - (loc_AE0E+2))[bx]
		push	large 39000Bh
		push	ds
		push	offset asc_226F8 ; "ÚÛ"
		push	0C1h ; 'Á'
		call	sub_1DBE
		push	large 39000Dh
		push	ds
		push	offset asc_226FD ; "ÜÝ"
		push	0C1h ; 'Á'
		call	sub_1DBE
		push	large 3E0015h
		push	ds
		push	offset asc_22702 ; "Þß"
		jmp	short loc_1078E
; ---------------------------------------------------------------------------
...
; ---------------------------------------------------------------------------
		db 0
		dw offset loc_72E+2 - (offset loc_AE0E+2)
		dw offset loc_75F+1 - (offset loc_AE0E+2)
		dw offset loc_75F+1 - (offset loc_AE0E+2)
		dw offset loc_75F+1 - (offset loc_AE0E+2)
		dw offset loc_B0D8
		dw 0
...
var_1		= byte ptr -1
		...
		ja	short loc_12951
		add	bx, bx
		jmp	word ptr cs:(loc_2965+1	- (loc_AE0E+2))[bx]
		mov	[bp+var_1], 0Fh
		jmp	short loc_12942
; ---------------------------------------------------------------------------
...
; ---------------------------------------------------------------------------
		db 0
		dw offset loc_294A+1 - (offset loc_AE0E+2)
		dw offset loc_2951 - (offset loc_AE0E+2)
		dw offset loc_2951 - (offset loc_AE0E+2)
		dw offset loc_293D+1 - (offset loc_AE0E+2)
		dw offset loc_2951 - (offset loc_AE0E+2)
		dw offset loc_2951 - (offset loc_AE0E+2)
		dw offset loc_2938 - (offset loc_AE0E+2)
		dw offset loc_2951 - (offset loc_AE0E+2)
		dw offset loc_2951 - (offset loc_AE0E+2)
		dw offset loc_293D+1 - (offset loc_AE0E+2)
		dw offset loc_2951 - (offset loc_AE0E+2)
		...
		dw offset loc_2951 - (offset loc_AE0E+2)
		dw offset loc_2951 - (offset loc_AE0E+2)
		dw offset loc_2932 - (offset loc_AE0E+2)
; ---------------------------------------------------------------------------
		push	bp
		mov	bp, sp
		push	si
...
loc_12E0E:
		...
		jnz	short loc_12E1F
		sub	word ptr [si+2], 180h
		mov	byte ptr [bp-2], 0AAh ;	'ª'
		jmp	short loc_12E32
; ---------------------------------------------------------------------------

loc_12E1F:
		add	word ptr [si+2], 180h
		mov	byte ptr [bp-2], 0D6h ;	'Ö'
		cmp	byte ptr [bp-3], 0
		jnz	short loc_12E32
		mov	byte ptr [bp-1], 1
...
loc_14321:
		add	bx, bx
		jmp	word ptr cs:(loc_4355+1	- (loc_AE0E+2))[bx]
		neg	dx
...
; ---------------------------------------------------------------------------
		dw offset loc_4349 - (offset loc_AE0E+2)
		dw offset sub_4328 - (offset loc_AE0E+2)
		dw offset sub_4328+2 - (offset loc_AE0E+2)
		dw offset loc_434D - (offset loc_AE0E+2)
		dw offset loc_432C+4 - (offset loc_AE0E+2)
		dw offset loc_433C - (offset loc_AE0E+2)
		dw offset loc_433C+2 - (offset loc_AE0E+2)
		dw offset loc_434D - (offset loc_AE0E+2)
		dw offset loc_4331+1 - (offset loc_AE0E+2)
		dw offset loc_4338 - (offset loc_AE0E+2)
		dw offset loc_433C+4 - (offset loc_AE0E+2)
		dw offset loc_434D - (offset loc_AE0E+2)
		dw offset loc_433C - (offset loc_AE0E+2)
		dw offset loc_4338 - (offset loc_AE0E+2)
		dw offset loc_434D - (offset loc_AE0E+2)
