...
loc_E2E:
		...
		mov	bx, [bp+0Ah]
		mov	ds, ClipYT_seg
		mov	word ptr cs:loc_E82+1, bx
		mov	word ptr cs:loc_E8A+1, ax
		mov	word ptr cs:loc_ED4+1, ax
		xor	ax, ax
		mov	bp, dx
		jmp	short loc_E81
; ---------------------------------------------------------------------------
...
loc_501D:
		...
		retf
; ---------------------------------------------------------------------------
byte_5044	db 4, 0, 3, 0, 26h, 0, 2 dup(0FFh), 3, 0, 2Eh, 0, 32h
		db 0Dh dup(0), 1, 0, 1,	0, 14h,	3
		dw seg seg007
		db 5, 0, 36h, 0, 73h, 74h, 72h,	69h, 6Eh, 67h, 0Eh dup(0)
byte_507E	db 6, 0, 3, 0, 26h, 0, 2 dup(0FFh), 7, 0, 2Eh, 0, 3Ah
		db 0Dh dup(0), 2, 0, 2,	0, 0C0h, 50h
		dw seg seg000
...
; ---------------------------------------------------------------------------
		...
		db 4 dup(0), 0C1h, 1
		dw seg seg007
		db 87h,	20h, 0FCh, 0FFh, 6 dup(0), 0E7h, 0AAh
		dw seg seg000
		db 0DEh, 0FFh, 2 dup(0), 5, 3 dup(0), 2	dup(0FFh), 6, 0
		db 5, 3	dup(0),	0F3h, 0AAh
; ---------------------------------------------------------------------------
		push	bp
		mov	bp, sp
		push	si
...
unknown_libname_4:			; BCC v4.x/5.x DOS runtime
		...
		retf
; ---------------------------------------------------------------------------
		db 4 dup(0), 0B6h, 0ABh
		dw seg seg000
		db 0E2h, 0FFh, 9, 0Ch
		dw seg seg007
		dd 0
		dd byte_1D9DF
		db 4, 0, 0FCh, 0FFh, 2 dup(0), 9, 0Ch
		dw seg seg007
		db 4, 0, 0F8h, 0FFh, 6 dup(0), 97h, 0Bh
		dw seg seg007
		db 0, 2	dup(1),	7 dup(0), 0C0h,	0ABh
		dw seg seg000
		db 0DAh, 0FFh, 2 dup(0), 5, 3 dup(0), 0C8h, 0ABh, 6, 0
		db 5, 0, 1, 0, 0E0h, 0ABh, 9, 0Ch
		dw seg seg007
		db 4 dup(0), 0CFh, 0Bh
		dw seg seg007
		db 4, 0, 0FCh, 0FFh, 2 dup(0), 9, 0Ch
		...
		db 4, 0, 0F8h, 0FFh, 6 dup(0), 97h, 0Bh
		dw seg seg007
		db 0, 2	dup(1),	7 dup(0), 4, 0ACh
		dw seg seg000
		db 0DAh, 0FFh, 2 dup(0), 5, 3 dup(0), 0Ch, 0ACh, 6, 0
		db 5, 0, 1, 0, 24h, 0ACh, 9, 0Ch
		dw seg seg007
		dd 0
		dd byte_1D9DF
		db 4, 0, 0FCh, 0FFh, 2 dup(0), 9, 0Ch
		...
		db 4, 0, 0F8h, 0FFh, 6 dup(0), 97h, 0Bh
		dw seg seg007
		db 0, 2	dup(1),	7 dup(0), 48h, 0ACh
		dw seg seg000
		db 0DAh, 0FFh, 2 dup(0), 5, 3 dup(0), 50h, 0ACh, 6, 0
		db 5, 0, 1, 0, 68h, 0ACh, 4 dup(0), 8Ch, 0ACh
		dw seg seg000
		db 0E2h, 0FFh, 55h, 0Bh
		dw seg seg007
		dd byte_1DA19
		db 4 dup(0), 96h, 0ACh
		dw seg seg000
		db 0E2h, 0FFh, 4 dup(0), 0A8h, 0ACh
		dw seg seg000
		db 0E2h, 0FFh, 55h, 0Bh
		dw seg seg007
		dd byte_1D917
		db 4 dup(0), 0B2h, 0ACh
		dw seg seg000
		db 0E2h, 0FFh, 4 dup(0), 0C4h, 0ACh
		dw seg seg000
		db 0E2h, 0FFh, 55h, 0Bh
		dw seg seg007
		dd byte_1D917
		db 4 dup(0), 0CEh, 0ACh
		dw seg seg000
		db 0E2h, 0FFh
; ---------------------------------------------------------------------------
		push	bp
...
loc_BA33:
		push	large 12000Ch
		push	ds
		push	offset asc_1DB5F ; "œœœœœœœœœœœ"
...
sub_E012	proc near
		...
		push	large 390011h
		push	ds
		push	offset asc_1E61F ; "… "
		push	0C1h ; '¡'
		call	sub_145A
		call	sub_DF76
		push	large 39000Fh
		push	ds
		push	offset asc_1E624 ; "ÃÕ"
		push	0C1h ; '¡'
		call	sub_145A
		call	sub_DFC4
		push	large 390014h
		push	ds
		push	offset asc_1E629 ; "«»"
		push	0C1h ; '¡'
		call	sub_145A
		call	sub_DEAD
		push	large 390016h
...
loc_FCFB:
		...
		push	0Eh
		push	ds
		push	offset aSMvpik	; "ËÀåÇèâä˙êî"
		push	ss
		lea	ax, [bp+var_6]
		push	ax
		les	bx, dword_2026C
...
loc_FEB9:
		...
		push	0Ch
		push	ds
		push	offset aGngkgagGcga ; "ÉNÉäÉAÉ^ÉCÉÄ"
		push	ss
		lea	ax, [bp+var_6]
		push	ax
		push	si
...
loc_1131F:
		...
		add	ax, 0Ch
		mov	di, ax
		cmp	word_20650, 98h	; 'ò'
		jge	short loc_11381
		cmp	word_20650, 80h	; 'Ä'
		jnz	short loc_1134D
		mov	byte_22FA6, 0
		mov	byte_22FA7, 80h	; 'Ä'
...
loc_121C9:
		cmp	word_22D54, 9Fh	; 'ü'
		jnz	short loc_121DE
		mov	byte_20664, 0
		mov	word_22D54, 97h	; 'ó'
		jmp	short loc_121E2
; ---------------------------------------------------------------------------
...
loc_18142:
		cmp	word_20650, 0EAh ; 'Í'
		jge	short loc_1815F
		mov	bx, word_2065C
		sub	word ptr [bx], 2
		cmp	word ptr [bx], 90h ; 'ê'
		jg	short loc_18170
		mov	word_20650, 0EAh ; 'Í'
		jmp	short loc_18170
; ---------------------------------------------------------------------------
...
loc_18A53:
		...
		add	sp, 2
		mov	word_2064E, 83h	; 'É'
		mov	byte ptr word_26CDC, 0D8h ; 'ÿ'
		pop	bp
		retn
; ---------------------------------------------------------------------------
...
arg_0		= word ptr  4
		...
		push	large 1B0004h
		push	ds
		push	offset asc_1EDF9 ; "π∏≤∂Ω"
		push	81h ; 'Å'
		call	sub_145A
		push	large 290004h
		push	ds
		push	offset asc_1EDFF ; "ºΩ"
		push	81h ; 'Å'
		call	sub_145A
		cmp	[bp+arg_0], 0FFFFh
		jz	short loc_1C82E
...
loc_1CC8A:
		...
		mov	bx, [bp+var_2]
		imul	bx, 7
		mov	byte ptr [bx+si+78BCh],	0CFh ; 'œ'
		inc	si
		cmp	si, 5
		jle	short loc_1CCD0
		jmp	short loc_1CCC6
...
; ---------------------------------------------------------------------------
byte_1CE8E	db 6, 0, 3, 0, 26h, 0, 2 dup(0FFh), 7, 0, 2Eh, 0, 3Ah
		db 0Dh dup(0), 2, 0, 2,	0, 95h,	0AAh
		dw seg seg000
		db 5, 0, 3Eh, 0, 78h, 61h, 2 dup(6Ch), 6Fh, 63h, 2 dup(0)
		db 0C0h, 0
		dw seg seg007
		db 2 dup(0), 3,	0Dh dup(0), 4, 0, 3, 0,	26h, 0,	2 dup(0FFh)
		db 3, 0, 2Ch, 0, 30h, 0Dh dup(0), 1, 0,	1, 0, 9Ch, 71h
		dw seg seg000
		db 5, 0, 34h, 0, 78h, 6Dh, 73h,	67h, 0Eh dup(0)
...
; ---------------------------------------------------------------------------
		db 4, 0, 90h, 20h, 0Ah,	0, 0A0h, 2
		dw seg seg007
aTstringref	db 'TStringRef *',0
byte_1CFE8	db 4, 0, 3, 0, 26h, 0, 2 dup(0FFh), 7, 0, 3Ah, 0, 46h
		db 0Dh dup(0), 2, 0, 2,	0, 17h,	0ABh
		dw seg seg000
		db 5, 0, 4Ah, 0
aStringLengther	db 'string::lengtherror',0
		...
		dw 0
		db 3, 0Dh dup(0)
byte_1D036	db 6, 0, 3, 0, 26h, 0, 2 dup(0FFh), 7, 0, 2Eh, 0, 3Ah
		db 0Dh dup(0), 2, 0, 2,	0, 64h,	0ABh
		dw seg seg000
		db 5, 0, 3Eh, 0, 78h, 61h, 2 dup(6Ch), 6Fh, 63h, 2 dup(0)
		db 68h,	2
		dw seg seg007
		db 2 dup(0), 3,	0Dh dup(0)
byte_1D078	db 4, 0, 3, 0, 26h, 0, 2 dup(0FFh), 3, 0, 2Ch, 0, 30h
		db 0Dh dup(0), 1, 0, 1,	0, 9Ch,	71h
		dw seg seg000
...
; int __cdecl __far sub_1D4C7(void (*driver)(void), char)
sub_1D4C7	proc far
...
@string@max_waste$qui:
		...
		retf
; ---------------------------------------------------------------------------
byte_1D917	db 4, 0, 3, 0, 26h, 0, 2 dup(0FFh), 7, 0, 3Ah, 0, 46h
		db 0Dh dup(0), 2, 0, 2,	0, 15h,	0ADh
		dw seg seg000
		db 5, 0, 4Ah, 0
aStringLength_0	db 'string::lengtherror',0
		dd byte_1D9A7
		db 2 dup(0), 3,	0Dh dup(0), 6, 0, 3, 0,	26h, 0,	2 dup(0FFh)
		db 7, 0, 2Eh, 0, 3Ah, 0Dh dup(0), 2, 0,	2, 0, 62h, 0ADh
		dw seg seg000
		db 5, 0, 3Eh, 0, 78h, 61h, 2 dup(6Ch), 6Fh, 63h, 2 dup(0)
		db 97h,	0Bh
		dw seg seg007
		db 2 dup(0), 3,	0Dh dup(0)
byte_1D9A7	db 4, 0, 3, 0, 26h, 0, 2 dup(0FFh), 3, 0, 2Ch, 0, 30h
		db 0Dh dup(0), 1, 0, 1,	0, 9Ch,	71h
		dw seg seg000
		db 5, 0, 34h, 0, 78h, 6Dh, 73h,	67h, 0Eh dup(0)
byte_1D9DF	db 4, 0, 3, 0, 26h, 0, 2 dup(0FFh), 3, 0, 2Eh, 0, 32h
		db 0Dh dup(0), 1, 0, 1,	0, 14h,	3
		dw seg seg007
		db 5, 0, 36h, 0, 73h, 74h, 72h,	69h, 6Eh, 67h, 0Eh dup(0)
byte_1DA19	db 4, 0, 3, 0, 26h, 0, 2 dup(0FFh), 7, 0, 3Ah, 0, 46h
		db 0Dh dup(0), 2, 0, 2,	0, 0AFh, 0ADh
		dw seg seg000
		db 5, 0, 4Ah, 0
aStringOutofran	db 'string::outofrange',0
		db 0, 97h, 0Bh
		dw seg seg007
		db 2 dup(0), 3,	16h dup(0)
seg007		ends
...
aStage1_Gaiji		db 'ºΩ™∞Æ°',0
		dd 0
		dd 0
		db    0
aExtra_Gaiji		db 'Æ¡Ωª™œœºΩ™∞Æ',0
		db 0
		db    0
		db    0
...
STAGE_TITLE_HALFLENGTHS		db  0Ah
		...
		db  0Dh
aNoK		db '≠Æ∑∏œπµ™¬',0
aKOO		db 'π™æºÆœ∑Æ∂æ',0
asc_1DB5F	db 'œœœœœœœœœœœ',0
					; sub_B9E2+175o ...
		db 0
...
asc_1E3F6	db '´∏∂æº',0
aUqiUx		db ' ìÔà’ìx',0
aGxgebGw	db 'ÉXÉeÅ[ÉW',0
aGGa		db 'É{ÉÄ',0
aGGx		db 'É~ÉX',0
aSMvpik		db 'ËÀåÇèâä˙êî',0
aSCPik		db 'ËÀñ≤èâä˙êî',0
aU_		db 'ì_',0
					; sub_FE12+CEo
aB		db 'Å~',0
					; sub_FE12+F3o
...
aGGxi		db 'É~ÉXâÒêî',0
aGGai		db 'É{ÉÄâÒêî',0
aGngkgagGcga	db 'ÉNÉäÉAÉ^ÉCÉÄ',0
aKOO_0		db '∞™∑Æ∏øÆª',0
aMO		db '¨∏∂Ω≤∂æÆ›',0
aO		db '¬Æº',0
asc_1E473	db '∂∏',0
