...
loc_DA9C:
		...
		inc	byte_1E59C
		call	sub_DF76
		call	snd_se_play c, 8

loc_DAB6:
		mov	bx, [bp+arg_0]
		mov	byte ptr [bx], 2
		call	snd_se_play c, 13
		cmp	byte_218A8, 20h	; ' '
		jb	short loc_DAD9
		inc	word_1E586
		mov	al, byte_218A8
