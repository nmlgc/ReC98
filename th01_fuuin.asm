...
loc_30B0:
		...
		mov	es, bx
		mov	es:2, ax
sub_3055	endp ; sp-analysis failed
...
; int __cdecl __far sub_5576(char *s, char)
sub_5576	proc far
...
arg_E		= word ptr  14h
		...
		add	sp, 0Ah
		push	ds
		push	offset aGxgebGwbeglbGg ; "ƒXƒe[ƒWEƒ‹[ƒg"
		push	33h ; '3'
		push	30h ; '0'
		push	200h
		call	sub_E10C
...
var_10		= byte ptr -10h
		...
		push	ds
		push	offset aB@r_oB@b@b@b@b ; "@_ŽÐ@@@@i‚P–Ê`‚T–Êj @ %3lu"
		push	0Fh		; int
		push	0C0h ; 'À'      ; int
		push	128h		; int
		call	sub_E9E4
		...
		push	word_13EE0
		push	ds
		push	offset aB@gqbGgb@b@b@b ; "@ƒQ[ƒg@@@i‚U–Ê`‚P‚O–Êj  %3lu"
		jmp	short loc_C59C
; ---------------------------------------------------------------------------
...
loc_C59C:
		...
		push	word_13EE4
		push	ds
		push	offset aGfgbgivFpBivpv ; "  ƒ”ƒBƒi‚Ì”pšÐi‚P‚P–Ê`‚P‚T–Êj%3lu"
		jmp	short loc_C5D5
; ---------------------------------------------------------------------------
...
loc_C5C9:
		...
		push	ds
		push	offset aB@ikvXekeb@b@b ; "@‰Š‚Ì•…ŠE@@i‚P‚P–Ê`‚P‚T–Êj%3lu"
...
loc_C647:
		...
		call	sub_C9B0
		push	ds
		push	offset aBBBVavVVPNjbBB ; "ššš‚ ‚È‚½‚ÌÌ†ššš"
		push	12h		; int
		push	180h		; int
		push	108h		; int
		call	sub_E9E4
...
aGxgebGwbeglbGg	db 'ƒXƒe[ƒWEƒ‹[ƒg',0
aB@sB@r_b@	db '@èË@_@',0
aSMRgcId	db '‘¾Œ³ƒ–¾‰¤',0
aB@uvb@rxb@	db '@“V@å@',0
aB@r_b@rxb@	db '@_@å@',0
...
aUmx		db '“Œ•ûèËˆÙ“`@‹­ŽÒ‚Ì‹L˜^@%s',0
		...
		dd aRvkeo		; "¢ŠEŽ÷‚Ì—t"
		dd aIitsluucr_tomo	; "‰©’é‹ã“C_’OŒo"
...
aRvkeo		db '¢ŠEŽ÷‚Ì—t',0
aIitsluucr_tomo	db '‰©’é‹ã“C_’OŒo',0
...
; char aB[]
aB@r_oB@b@b@b@b	db '@_ŽÐ@@@@i‚P–Ê`‚T–Êj @ %3lu',0
aB@gqbGgb@b@b@b	db '@ƒQ[ƒg@@@i‚U–Ê`‚P‚O–Êj  %3lu',0
; char aB[]
aB@tkb@b@b@b@b@	db '@âK@@@@@i‚U–Ê`‚P‚O–Êj  %3lu',0
aGfgbgivFpBivpv	db '  ƒ”ƒBƒi‚Ì”pšÐi‚P‚P–Ê`‚P‚T–Êj%3lu',0
; char aB[]
aB@ikvXekeb@b@b	db '@‰Š‚Ì•…ŠE@@i‚P‚P–Ê`‚P‚T–Êj%3lu',0
