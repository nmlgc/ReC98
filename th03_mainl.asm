...
CHAR_NAME		dd NAME_REIMU		; "   îéóÌÅ@ËÀñ≤"
		...
		dd NAME_MIMA		; "	ñ£ ñÇ"
		dd TITLE_MARISA	; "   ñÇñ@Ç∆çgñ≤Ç©ÇÁÇ»ÇÈë∂ç›   "
		dd NAME_MARISA		; "  ñ∂âJÅ@ñÇóùçπ "
		dd TITLE_ELLEN		; "ÇÕÇΩÇÁÇ´Ç‡ÇÃÇ≈óˆÇñ≤å©ÇÈñÇèó"
		dd NAME_ELLEN		; "Å@Å@ÉGÉåÉì"
		dd TITLE_KOTOHIME		; "	íeñãÇ…î¸Çñ≤Ç›ÇÈïP     "
		dd NAME_KOTOHIME		; "    è¨ìeïP"
		dd TITLE_KANA			; "	ñ≤Çé∏Ç¡ÇΩè≠èóëõóÏ     "
		dd NAME_KANA	; "ÉJÉiÅEÉAÉiÉxÉâÉã"
		dd TITLE_RIKAKO		; "  Å@Å@Å@ñ≤ÇíTÇ∑â»äw	       "
		dd NAME_RIKAKO	; "Å@í©ëqÅ@óùçÅéq"
		dd TITLE_CHIYURI		; "Å@  éûÇÇ©ÇØÇÈñ≤å∂ÇÃèZêl    "
		dd NAME_CHIYURI	; " ñkîíâÕÅ@ÇøÇ‰ÇË"
		dd TITLE_YUMEMI	; "Å@  Å@Å@Å@ñ≤å∂ì`ê‡Å@Å@Å@    "
...
TITLE_REIMU		db '   ñ≤Ç∆ì`ìùÇï€éÁÇ∑ÇÈõﬁèó   ',0
NAME_REIMU	db '   îéóÌÅ@ËÀñ≤',0
TITLE_MIMA	db ' ãvâìÇÃñ≤Ç…â^ñΩÇîCÇπÇÈê∏ê_ ',0
NAME_MIMA		db '     ñ£ ñÇ',0
TITLE_MARISA	db '   ñÇñ@Ç∆çgñ≤Ç©ÇÁÇ»ÇÈë∂ç›   ',0
NAME_MARISA	db '  ñ∂âJÅ@ñÇóùçπ ',0
TITLE_ELLEN	db 'ÇÕÇΩÇÁÇ´Ç‡ÇÃÇ≈óˆÇñ≤å©ÇÈñÇèó',0
NAME_ELLEN	db 'Å@Å@ÉGÉåÉì',0
TITLE_KOTOHIME		db '     íeñãÇ…î¸Çñ≤Ç›ÇÈïP     ',0
NAME_KOTOHIME		db '    è¨ìeïP',0
TITLE_KANA		db '     ñ≤Çé∏Ç¡ÇΩè≠èóëõóÏ     ',0
NAME_KANA	db 'ÉJÉiÅEÉAÉiÉxÉâÉã',0
TITLE_RIKAKO	db '  Å@Å@Å@ñ≤ÇíTÇ∑â»äw        ',0
NAME_RIKAKO	db 'Å@í©ëqÅ@óùçÅéq',0
TITLE_CHIYURI		db 'Å@  éûÇÇ©ÇØÇÈñ≤å∂ÇÃèZêl    ',0
NAME_CHIYURI	db ' ñkîíâÕÅ@ÇøÇ‰ÇË',0
TITLE_YUMEMI	db 'Å@  Å@Å@Å@ñ≤å∂ì`ê‡Å@Å@Å@    ',0
NAME_YUMEMI	db ' Å@â™çËÅ@ñ≤î¸',0
...
aOver_pi	db 'over.pi',0
		...
		dd aB@b@sCB@b@		; "Å@Å@ËÀñ≤Å@Å@"
		dd aB@b@cgcvb@b@	; "Å@Å@ñ£ñÇÅ@Å@"
		dd aB@cvcanB@		; " Å@ñÇóùçπÅ@ "
		dd aB@gggmgub@		; " Å@ÉGÉåÉìÅ@ "
		dd aB@pmuexpb@		; " Å@è¨ìeïPÅ@ "
		dd aB@Gjgi		; " Å@ ÉJÉi    "
		dd aB@canboq		; " Å@óùçÅéq   "
		dd aB@vVfvsb@		; " Å@ÇøÇ‰ÇËÅ@ "
		dd aB@CF		; " Å@ ñ≤î¸Å@  "
		db  14h
		db    4
		db    8
...
aB@b@sCB@b@	db 'Å@Å@ËÀñ≤Å@Å@',0
aB@b@cgcvb@b@	db 'Å@Å@ñ£ñÇÅ@Å@',0
aB@cvcanB@	db ' Å@ñÇóùçπÅ@ ',0
aB@gggmgub@	db ' Å@ÉGÉåÉìÅ@ ',0
aB@pmuexpb@	db ' Å@è¨ìeïPÅ@ ',0
aB@Gjgi		db ' Å@ ÉJÉi    ',0
aB@canboq	db ' Å@óùçÅéq   ',0
aB@vVfvsb@	db ' Å@ÇøÇ‰ÇËÅ@ ',0
aB@CF		db ' Å@ ñ≤î¸Å@  ',0
