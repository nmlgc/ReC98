...
loc_146A:
		...
		push	cx
		mov	dh, 0
		mov	dl, byte ptr ds:[4112h]
		mov	cl, byte ptr ds:[4113h]
		cmp	cl, ch
		jnb	short loc_1496
		shl	dx, cl
		mov	si, word_12640
...
loc_1496:
		...
		shl	dx, cl
		sub	ch, cl
		mov	byte ptr ds:[4112h], dl
		mov	byte ptr ds:[4113h], ch
		mov	dl, dh
		mov	dh, 0
		pop	cx
		mov	bl, dl
