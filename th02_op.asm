...
aTselect_pi	db 'TSELECT.pi',0
		...
		dd aNo_5VVrvivmbav	; "NO.5	   ‚Ğ‚à‚ë‚¬A‚Ş‚ç‚³‚«‚É‚à‚¦"
		dd aNo_6B@umx		; "NO.6	   @“Œ•û••–‚˜^@`—HŒ¶—•‘"
		dd aNo_7B@SheSInAT	; "NO.7	   @  She's in a temper!! "
		dd aNo_8B@B@VtvVVV	; "NO.8	   @  @ ‚â‚İ‚Ì‚¿‚©‚ç@@ "
		dd aNo_9B@b@b@b@oa	; "NO.9	   @@@@€‚ğ“q‚µ‚Ä@@@"
		...
		dd aNo_15RaoVVVVVV	; "NO.15      íÔ‚Ş‚·‚ß‚Ì‚İ‚é‚ä‚ß "
		dd aB@b@		; "	      @@		   "
		dd aB@b@vpvxvivf	; "	      @@‚p‚•‚‰‚”	   "
		dd aOp_m_0		; "op.m"
...
aNo_5VVrvivmbav	db 'NO.5    ‚Ğ‚à‚ë‚¬A‚Ş‚ç‚³‚«‚É‚à‚¦',0
aNo_6B@umx	db 'NO.6    @“Œ•û••–‚˜^@`—HŒ¶—•‘',0
aNo_7B@SheSInAT	db 'NO.7    @  She',27h,'s in a temper!! ',0
aNo_8B@B@VtvVVV	db 'NO.8    @  @ ‚â‚İ‚Ì‚¿‚©‚ç@@ ',0
aNo_9B@b@b@b@oa	db 'NO.9    @@@@€‚ğ“q‚µ‚Ä@@@',0
...
aNo_15RaoVVVVVV	db 'NO.15      íÔ‚Ş‚·‚ß‚Ì‚İ‚é‚ä‚ß ',0
aB@b@		db '           @@                 ',0
