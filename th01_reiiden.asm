...
sub_CC0F	proc far
		...
		pop	cx
		call	_graph_copy_page_back_to_front
		call	_graph_putsa_fx c, 0, ((FX_CLEAR_BG or 27h) shl 16) or 0, offset aVgvpvovfvivovx, ds ; "ｃｏｎｔｉｎｕｅ？　　　  "
		call	_graph_putsa_fx c, 0, ((FX_CLEAR_BG or 27h) shl 16) or 16, offset aVxvevub@b@B@, ds ; "Ｙｅｓ　　  　"
		call	_graph_putsa_fx c, 0, ((FX_CLEAR_BG or 27h) shl 16) or 32, offset aVmvpb@b@B@, ds ; "Ｎｏ　　	　 "
		call	_graph_putsa_fx c, 0, ((FX_CLEAR_BG or 21h) shl 16) or 48, offset aVxvevub@b@c@, ds ; "Ｙｅｓ　　　  "
		call	_graph_putsa_fx c, 0, ((FX_CLEAR_BG or 21h) shl 16) or 64, offset aVmvpb@b@c@, ds ; "Ｎｏ　　　   "
		push	0
		call	_graph_accesspage_func
		pop	cx
		push	100090h
...
loc_127AC:
		...
		call	_graph_accesspage_func
		call	_z_graph_clear
		call	_graph_putsa_fx stdcall, 0, large ((FX_CLEAR_BG or 7) shl 16) or 0, offset aVqvnvtvmvcb@vp, ds ; "ＲＯＵＮＤ　１　ＣＬＥＡＲ"
		call	_graph_putsa_fx stdcall, 0, large ((FX_CLEAR_BG or 7) shl 16) or 32, offset aVbvpvovzvtvbvf, ds ; "Ｃｏｎｇｒａｔｕｌａｔｉｏｎ！！"
		call	_graph_putsa_fx stdcall, 0, large ((FX_CLEAR_BG or 7) shl 16) or 64, offset aVrvevmvevgvfb@, ds ; "Ｓｅｌｅｃｔ　ｎｅｘｔ　Ｒｏｕｎｄ"
...
loc_19C94:
		...
		shl	ax, 2
		add	bx, ax
		mov	eax, dword ptr es:[bx+ptn_t.planes]
