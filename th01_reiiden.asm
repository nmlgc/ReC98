...
arg_6		= byte ptr  0Ch
		...
		mov	eax, VRAM_PLANE_B
		mov	dword_35B32, eax
		mov	eax, VRAM_PLANE_R
		mov	dword_35B36, eax
		mov	eax, VRAM_PLANE_G
		mov	dword_35B3A, eax
		mov	eax, VRAM_PLANE_E
		mov	dword_35B3E, eax
		lea	ax, [bp+var_30]
		push	ss
		push	ax
