...
byte_DDE0	db 0
		db 0
		dd aNo_1B@cVOul		; "NO.1	    @–²‚Í‹ó‚ğ‰z‚¦‚Ä	   "
		...
		dd aNo_17IiiuvCumo	; "NO.17	 ‰i‰“‚Ì–Œ	   "
...
byte_DE82	db 0
byte_DE83	db 0
aNo_1B@cVOul	db 'NO.1     @–²‚Í‹ó‚ğ‰z‚¦‚Ä     ',0
...
aNo_17IiiuvCumo	db 'NO.17         ‰i‰“‚Ì–Œ        ',0
