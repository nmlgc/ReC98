...
loc_CADF:
		...
		push	0Eh
		push	ds
		push	offset aVgdejziiklm ; "‚ƒ„…†‡ˆ‰Š‹Œ"
		push	di
		call	gaiji_putsa
		mov	al, [bp+arg_2]
		mov	ah, 0
		...
		push	0Fh
		push	ds
		push	offset asc_1DD39 ; "ÇÈÉÊËÌÍÎ"
		push	di
		call	gaiji_putsa
		lea	ax, [si+13h]
		push	ax
...
loc_CB47:
		...
		push	0Fh
		push	ds
		push	offset asc_1DD42 ; "ÐÑÒÊËÌÍÎ"
		push	di
		call	gaiji_putsa
		lea	ax, [si+13h]
		push	ax
...
loc_CB60:
		...
		push	10h
		push	ds
		push	offset aNoptufxccssI ; "Ž’“”•–—˜™š›œ"
		push	di
		call	gaiji_putsa
		pop	di
		pop	si
...
loc_CE20:
		...
		add	ax, 10h
		mov	[si+4],	ax
		mov	byte ptr [si+6], 88h ; 'ˆ'
		mov	byte ptr [si+7], 0F8h ;	'ø'
		pop	si
		pop	bp
		retf	6
sub_CE0C	endp
...
loc_E411:
		...
		push	8
		push	ds
		push	offset aVlvVwb@vbvpvnv ; "‚l‚`‚w@‚b‚‚‚‚‚@@@~"
		push	0E1h ; 'á'
		call	text_putsa
		push	si
		push	0Ah
		push	ds
		push	offset aGqbGwgagGbgni ;	"ƒQ[ƒWƒAƒ^ƒbƒN‰ñ”@@@~"
		push	0E1h ; 'á'
		call	text_putsa
		push	si
		push	0Ch
		push	ds
		push	offset aGGxgagGbgni ; "ƒ{ƒXƒAƒ^ƒbƒN‰ñ”@@@@~"
		push	0E1h ; 'á'
		call	text_putsa
		push	si
		push	0Eh
		push	ds
		push	offset aGGxgkgobGtgli ;	"ƒ{ƒXƒŠƒo[ƒTƒ‹‰ñ”@@@~"
		push	0E1h ; 'á'
		call	text_putsa
		push	si
		push	10h
		push	ds
		push	offset aGGxgpgjgbgni ; "ƒ{ƒXƒpƒjƒbƒN‰ñ”@@@@~"
		push	0E1h ; 'á'
		call	text_putsa
		push	si
		push	14h
		...
		push	6
		push	ds
		push	offset aB@b@vvvhvmvmvd ; "@@‚v‚h‚m‚m‚d‚q@‚a‚n‚m‚t‚r@@"
		jmp	short loc_E4A2
; ---------------------------------------------------------------------------
...
loc_E48C:
		...
		push	6
		push	ds
		push	offset aB@b@b@vVkvkb@v ; "@@@‚`‚k‚k@‚b‚k‚d‚`‚qII@@"
		push	0E1h ; 'á'
		call	text_putsa
		push	si
		push	12h
		push	ds
		push	offset aOcvsrlrfb@b@b@ ; "Žc‚èl”@@@@@@@@~"
...
sub_10669	proc near
		...
		mov	ax, word_20E52
		mov	word_23E40, ax
		mov	byte ptr word_23E42+1, 0C0h ; 'À'
...
loc_14B55:
		...
		jl	short loc_14B38
		mov	bx, word_205CA
		mov	byte ptr [bx+1Eh], 0C0h	; 'À'
		mov	byte ptr [bx+1Fh], 0C0h	; 'À'
		jmp	short loc_14B73
; ---------------------------------------------------------------------------
...
loc_1BCAF:
		...
		jl	short loc_1BC8A
		sub	si, 36h	; '6'
		mov	byte ptr [si+34h], 0F0h	; 'ð'
		sub	si, 36h	; '6'
		mov	byte ptr [si+34h], 0C8h	; 'È'
		sub	si, 36h	; '6'
...
aPqrstuvwxyz	db 'pqrstuvwxyz{|}~'
		db  7Fh	; 
		db    0
aVgdejziiklm	db '‚ƒ„…†‡ˆ‰Š‹Œ',0
asc_1DD39	db 'ÇÈÉÊËÌÍÎ',0
asc_1DD42	db 'ÐÑÒÊËÌÍÎ',0
aNoptufxccssI	db 'Ž’“”•–—˜™š›œ',0
asc_1DD5A	db '                                ',0
		db 0
unk_1DD7C	db  0Ch
		db  0Dh
...
word_1DDAC	dw 2AB6h
		...
		db    0
		db    7
aVlvVwb@vbvpvnv	db '‚l‚`‚w@‚b‚‚‚‚‚@@@~',0
aGqbGwgagGbgni	db 'ƒQ[ƒWƒAƒ^ƒbƒN‰ñ”@@@~',0
aGGxgagGbgni	db 'ƒ{ƒXƒAƒ^ƒbƒN‰ñ”@@@@~',0
aGGxgkgobGtgli	db 'ƒ{ƒXƒŠƒo[ƒTƒ‹‰ñ”@@@~',0
aGGxgpgjgbgni	db 'ƒ{ƒXƒpƒjƒbƒN‰ñ”@@@@~',0
aB@b@b@vsvnvsvV	db '@@@‚s‚n‚s‚`‚k@@@@@',0
aB@b@vvvhvmvmvd	db '@@‚v‚h‚m‚m‚d‚q@‚a‚n‚m‚t‚r@@',0
aB@b@b@vVkvkb@v	db '@@@‚`‚k‚k@‚b‚k‚d‚`‚qII@@',0
aOcvsrlrfb@b@b@	db 'Žc‚èl”@@@@@@@@~',0
		db 0
		db '<',0
		db    0
		db    0
