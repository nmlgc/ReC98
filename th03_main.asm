...
seg000		segment	word public 'CODE' use16
		assume cs:seg000
		assume es:nothing, ss:seg014, ds:dseg, fs:nothing, gs:nothing
...
; ---------------------------------------------------------------------------
		...
		db 4, 0, 0CDh, 21h, 8Bh, 0C8h, 0A3h, 8,	3, 49h,	8Eh, 0C1h
		db 0B8h, 2 dup(0FFh), 26h, 0A3h, 1, 0, 41h, 8Eh, 0C1h
		db 0FCh, 33h, 0FFh, 0BEh, 0DEh,	5, 0B9h, 0Ah, 0, 0F3h
...
word_2D4D	dw 1234h
		...
		db 0, 8Eh, 0C6h, 26h, 0A3h, 2 dup(0), 0A1h, 94h, 1Ah, 8Eh
		...
		db 52h,	50h, 6Ah, 0, 0Eh, 0E8h,	61h, 0D8h, 0B8h, 0, 1Eh
		db 64h,	8Ah, 55h, 2, 8Eh, 0C6h,	0Ah, 0D2h, 74h,	8, 26h
		db 88h,	16h, 1Eh, 0, 0B8h, 44h,	1Eh, 26h, 0A3h,	4, 0, 8Eh
		db 0C1h, 64h, 8Bh, 5, 8Eh, 0C6h, 3Dh, 88h, 0F3h, 74h, 0Ah
		db 3Dh,	2 dup(95h), 74h, 0Fh, 0B8h, 5, 0, 0EBh,	4Fh, 26h
		db 0A1h, 4, 0, 26h, 0A3h, 2, 0,	0EBh, 15h, 26h,	0C7h, 6
		db 2, 0, 0B2h, 1Dh, 26h, 0C7h, 6, 1Ah, 3 dup(0), 26h, 0C7h
		db 6, 1Ch, 0, 2	dup(0FFh), 64h,	8Bh, 5Dh, 10h, 64h, 8Bh
		db 55h,	12h, 33h, 0C0h,	26h, 89h, 1Eh, 6, 0, 26h, 0A3h
		db 8, 0, 26h, 89h, 2 dup(16h), 0, 26h, 0A3h, 18h, 0, 26h
		db 0A3h, 0Ah, 0, 26h, 0A3h, 0Ch, 0, 26h, 0A3h, 12h, 0
		db 26h,	0A3h, 14h, 0, 8Bh, 0C6h, 0EBh, 1Ah, 0A3h, 0Eh
		db 3, 26h, 0FFh, 36h, 2	dup(0),	0Eh, 0E8h, 0Fh,	0D6h, 56h
		db 0Eh,	0E8h, 58h, 0F5h, 0EBh, 5, 0C6h,	6, 0Eh,	2 dup(3)
		db 33h,	0C0h, 5Fh, 5Eh,	0C9h, 0CAh, 8, 0, 90h
; ---------------------------------------------------------------------------
		push	bp
		mov	bp, sp
		push	si
...
loc_359F:
		...
		retf
; ---------------------------------------------------------------------------
byte_35C6	db 4, 0, 3, 0, 26h, 0, 2 dup(0FFh), 3, 0, 2Eh, 0, 32h
		db 0Dh dup(0), 1, 0, 1,	0, 0Fh,	3
		dw seg seg012
		db 5, 0, 36h, 0, 73h, 74h, 72h,	69h, 6Eh, 67h, 0Eh dup(0)
byte_3600	db 6, 0, 3, 0, 26h, 0, 2 dup(0FFh), 7, 0, 2Eh, 0, 3Ah
		db 0Dh dup(0), 2, 0, 2,	0, 42h,	36h
		dw seg seg000
...
; ---------------------------------------------------------------------------
		db 4 dup(0), 3Ch, 39h
		dw seg seg000
		db 14h dup(0), 0E2h, 0FFh, 2 dup(0), 3,	0, 0AEh, 38h
		dw seg seg000
		db 2 dup(0), 4,	0
...
; int __cdecl __far sub_4DD9(char *src,	__int32, char *pathname)
sub_4DD9	proc far
...
; ---------------------------------------------------------------------------
		...
		db 4 dup(0), 0BCh, 1
		dw seg seg012
		db 87h,	20h, 0FCh, 0FFh, 6 dup(0), 69h,	90h
		dw seg seg000
		db 0DEh, 0FFh, 2 dup(0), 5, 3 dup(0), 2	dup(0FFh), 6, 0
		db 5, 3	dup(0),	75h, 90h
; ---------------------------------------------------------------------------
		push	bp
		mov	bp, sp
		push	si
...
; ---------------------------------------------------------------------------
		...
		db 4 dup(0), 0CAh, 0Bh
		dw seg seg012
		db 4, 0, 0FCh, 0FFh, 2 dup(0), 4, 0Ch
		dw seg seg012
		db 4, 0, 0F8h, 0FFh, 6 dup(0), 92h, 0Bh
		dw seg seg012
		db 0, 2	dup(1),	7 dup(0), 42h, 91h
		dw seg seg000
		db 0DAh, 0FFh, 2 dup(0), 5, 3 dup(0), 4Ah, 91h,	6, 0, 5
		db 0, 1, 0, 62h, 91h, 4, 0Ch
		dw seg seg012
		db 4 dup(0), 0CAh, 0Bh
		dw seg seg012
		db 4, 0, 0FCh, 0FFh, 2 dup(0), 4, 0Ch
		...
		db 4, 0, 0F8h, 0FFh, 6 dup(0), 92h, 0Bh
		dw seg seg012
		db 0, 2	dup(1),	7 dup(0), 86h, 91h
		dw seg seg000
		db 0DAh, 0FFh, 2 dup(0), 5, 3 dup(0), 8Eh, 91h,	6, 0, 5
		db 0, 1, 0, 0A6h, 91h, 4, 0Ch
		dw seg seg012
		db 4 dup(0), 0CAh, 0Bh
		dw seg seg012
		db 4, 0, 0FCh, 0FFh, 2 dup(0), 4, 0Ch
		...
		db 4, 0, 0F8h, 0FFh, 6 dup(0), 92h, 0Bh
		dw seg seg012
		db 0, 2	dup(1),	7 dup(0), 0CAh,	91h
		dw seg seg000
		db 0DAh, 0FFh, 2 dup(0), 5, 3 dup(0), 0D2h, 91h, 6, 0
		db 5, 0, 1, 0, 0EAh, 91h, 4 dup(0), 0Eh, 92h
		dw seg seg000
		db 0E2h, 0FFh, 50h, 0Bh
		dw seg seg012
		dd byte_1D504
		db 4 dup(0), 18h, 92h
		dw seg seg000
		db 0E2h, 0FFh, 4 dup(0), 2Ah, 92h
		dw seg seg000
byte_9232	db 0E2h, 0FFh, 50h, 0Bh
		dw seg seg012
		dd byte_1D402
		dd 0
		dd byte_9232+2
		db 0E2h, 0FFh, 4 dup(0), 46h, 92h
		dw seg seg000
		db 0E2h, 0FFh, 50h, 0Bh
		dw seg seg012
		dd byte_1D402
...
; int __cdecl __far sub_9402(int, int, char *pathname, char *src, int)
sub_9402	proc far
...
; int __cdecl sub_948B(int, char *s, int, int, int, int, int)
sub_948B	proc near
...
loc_96DF:
		...
		pop	bp
		retn
sub_948B	endp ; sp-analysis failed
...
loc_9845:
		nop
		push	cs
		call	near ptr sub_CA3C
		push	0
		nop
		push	cs
		call	near ptr sub_CB81
		push	1
		nop
		push	cs
		call	near ptr sub_CB81
...
loc_BAE8:
		push	si
		push	cs
		call	near ptr sub_B92F
		push	si
		push	cs
		call	near ptr sub_B9AB
		push	si
		call	sub_BA12
		push	si
		push	cs
		call	near ptr sub_BA91
		inc	si
...
loc_E411:
		...
		push	6
		push	ds
		push	offset aB@b@vvvhvmvmvd ; "Å@Å@ÇvÇhÇmÇmÇdÇqÅ@ÇaÇnÇmÇtÇrÅ@Å@"
		jmp	short loc_E4A2
; ---------------------------------------------------------------------------
...
loc_E48C:
		...
		push	12h
		push	ds
		push	offset aOcvsrlrfb@b@b@ ; "écÇËêlêîÅ@Å@Å@Å@Å@Å@Å@Å@Å~"
...
loc_EE81:
		push	cs
		call	near ptr sub_ED54
		cmp	word ptr unk_1EFFA, 0
		jz	short loc_EE95
		push	1
		nop
		push	cs
		call	near ptr sub_EA77
		jmp	short loc_EE81
; ---------------------------------------------------------------------------
...
loc_177AF:
		...
		cmp	byte ptr word_23E42, 80h ; 'Ä'
		jbe	short loc_177CA
		mov	byte ptr word_23E42, 80h ; 'Ä'
		jmp	short loc_177D6
; ---------------------------------------------------------------------------
...
loc_18801:
		...
		imul	ax, 3
		mov	bx, ax
		mov	byte ptr [bx+11BBh], 80h ; 'Ä'
		mov	al, byte ptr word_1FE88
		mov	ah, 0
		imul	ax, 3
		mov	bx, ax
		mov	byte ptr [bx+11BCh], 80h ; 'Ä'
		jmp	short loc_18872
; ---------------------------------------------------------------------------
...
loc_1C0E4:
		...
		add	ax, ax
		mov	bx, ax
		sub	word ptr [bx+2676h], 80h ; 'Ä'

loc_1C0F3:
		mov	al, byte ptr word_1FE88
		mov	ah, 0
		mov	bx, ax
		cmp	byte ptr [bx+267Ah], 80h ; 'Ä'
		jb	short loc_1C119
		mov	al, byte ptr word_1FE88
		mov	ah, 0
		mov	bx, ax
...
; ---------------------------------------------------------------------------
byte_1C979	db 6, 0, 3, 0, 26h, 0, 2 dup(0FFh), 7, 0, 2Eh, 0, 3Ah
		db 0Dh dup(0), 2, 0, 2,	0, 17h,	90h
		dw seg seg000
		db 5, 0, 3Eh, 0, 78h, 61h, 2 dup(6Ch), 6Fh, 63h, 2 dup(0)
		db 0BBh, 0
		dw seg seg012
		db 2 dup(0), 3,	0Dh dup(0), 4, 0, 3, 0,	26h, 0,	2 dup(0FFh)
		db 3, 0, 2Ch, 0, 30h, 0Dh dup(0), 1, 0,	1, 0, 1Eh, 57h
		dw seg seg000
		db 5, 0, 34h, 0, 78h, 6Dh, 73h,	67h, 0Eh dup(0)
...
; int __cdecl __far string__string(__int32, char *src)
...
; ---------------------------------------------------------------------------
		db 4, 0, 90h, 20h, 0Ah,	0, 9Bh,	2
		dw seg seg012
aTstringref	db 'TStringRef *',0
byte_1CAD3	db 4, 0, 3, 0, 26h, 0, 2 dup(0FFh), 7, 0, 3Ah, 0, 46h
		db 0Dh dup(0), 2, 0, 2,	0, 99h,	90h
		dw seg seg000
		db 5, 0, 4Ah, 0
aStringLengther	db 'string::lengtherror',0
		dd byte_1CB63
		db 2 dup(0), 3,	0Dh dup(0)
byte_1CB21	db 6, 0, 3, 0, 26h, 0, 2 dup(0FFh), 7, 0, 2Eh, 0, 3Ah
		db 0Dh dup(0), 2, 0, 2,	0, 0E6h, 90h
		dw seg seg000
		db 5, 0, 3Eh, 0, 78h, 61h, 2 dup(6Ch), 6Fh, 63h, 2 dup(0)
		db 63h,	2
		dw seg seg012
		db 2 dup(0), 3,	0Dh dup(0)
byte_1CB63	db 4, 0, 3, 0, 26h, 0, 2 dup(0FFh), 3, 0, 2Ch, 0, 30h
		db 0Dh dup(0), 1, 0, 1,	0, 1Eh,	57h
		dw seg seg000
...
; int __cdecl __far sub_1CFB2(void (*driver)(void), char)
sub_1CFB2	proc far
...
; ---------------------------------------------------------------------------
byte_1D402	db 4, 0, 3, 0, 26h, 0, 2 dup(0FFh), 7, 0, 3Ah, 0, 46h
		db 0Dh dup(0), 2, 0, 2,	0, 97h,	92h
		dw seg seg000
		db 5, 0, 4Ah, 0
aStringLength_0	db 'string::lengtherror',0
		dd byte_1D492
		db 2 dup(0), 3,	0Dh dup(0), 6, 0, 3, 0,	26h, 0,	2 dup(0FFh)
		db 7, 0, 2Eh, 0, 3Ah, 0Dh dup(0), 2, 0,	2, 0, 0E4h, 92h
		dw seg seg000
		db 5, 0, 3Eh, 0, 78h, 61h, 2 dup(6Ch), 6Fh, 63h, 2 dup(0)
		db 92h,	0Bh
		dw seg seg012
		dw 0
		db 3, 0Dh dup(0)
byte_1D492	db 4, 0, 3, 0, 26h, 0, 2 dup(0FFh), 3, 0, 2Ch, 0, 30h
		db 0Dh dup(0), 1, 0, 1,	0, 1Eh,	57h
		dw seg seg000
		...
		dw seg seg012
		db 5, 0, 36h, 0, 73h, 74h, 72h,	69h, 6Eh, 67h, 0Eh dup(0)
byte_1D504	db 4, 0, 3, 0, 26h, 0, 2 dup(0FFh), 7, 0, 3Ah, 0, 46h
		db 0Dh dup(0), 2, 0, 2,	0, 31h,	93h
		dw seg seg000
		db 5, 0, 4Ah, 0
		db 'string::outofrange',0
		db 0
		dd byte_1D492
		dw 0
		db 3, 1Bh dup(0)
...
word_1DDAC	dw 2AB6h
		...
		db    0
		db    7
aVlvVwb@vbvpvnv	db 'ÇlÇ`ÇwÅ@ÇbÇèÇçÇÇÇèÅ@Å@Å@Å~',0
aGqbGwgagGbgni	db 'ÉQÅ[ÉWÉAÉ^ÉbÉNâÒêîÅ@Å@Å@Å~',0
aGGxgagGbgni	db 'É{ÉXÉAÉ^ÉbÉNâÒêîÅ@Å@Å@Å@Å~',0
aGGxgkgobGtgli	db 'É{ÉXÉäÉoÅ[ÉTÉãâÒêîÅ@Å@Å@Å~',0
aGGxgpgjgbgni	db 'É{ÉXÉpÉjÉbÉNâÒêîÅ@Å@Å@Å@Å~',0
aB@b@b@vsvnvsvV	db 'Å@Å@Å@ÇsÇnÇsÇ`ÇkÅ@Å@Å@Å@Å@',0
aB@b@vvvhvmvmvd	db 'Å@Å@ÇvÇhÇmÇmÇdÇqÅ@ÇaÇnÇmÇtÇrÅ@Å@',0
aB@b@b@vVkvkb@v	db 'Å@Å@Å@Ç`ÇkÇkÅ@ÇbÇkÇdÇ`ÇqÅIÅIÅ@Å@',0
aOcvsrlrfb@b@b@	db 'écÇËêlêîÅ@Å@Å@Å@Å@Å@Å@Å@Å~',0
		db 0
		db '<',0
		db    0
		db    0
...
byte_26353	db ?
					; sub_17730+F5r ...
word_26354	dw ?
					; sub_17A1B:loc_17ABDw	...
byte_26356	db ?
					; sub_158F5:loc_15914w	...
byte_26357	db ?
byte_26358	db ?
					; sub_181C3+7Ew ...
		db    ?	;
...
seg014		segment	byte stack 'STACK' use16
		assume cs:seg014
		assume es:nothing, ss:nothing, ds:dseg,	fs:nothing, gs:nothing
		db 80h dup(?)
seg014		ends
