...
loc_10245:
		...
		mov	Palettes+43, 0B0h ; 'ｰ'
		mov	Palettes+44, 0C0h
		jmp	short loc_10288
; ---------------------------------------------------------------------------

loc_10281:
		cmp	byte_256A9, 0B0h ; 'ｰ'
		jnb	short loc_1028E
...
loc_1A735:
		mov	byte_26718, 0A6h ; 'ｦ'
		jmp	short loc_1A767
; ---------------------------------------------------------------------------

loc_1A73C:
		mov	byte_26718, 0A8h ; 'ｨ'
		jmp	short loc_1A767
; ---------------------------------------------------------------------------

loc_1A743:
		mov	byte_26718, 0AAh ; 'ｪ'
		jmp	short loc_1A767
; ---------------------------------------------------------------------------

loc_1A74A:
		mov	byte_26718, 0ACh ; 'ｬ'
		jmp	short loc_1A767
; ---------------------------------------------------------------------------
...
loc_1A7EA:
		mov	byte_26718, 0B0h ; 'ｰ' ; jumptable 0001A7DF case 8
		jmp	short loc_1A815	; default
; ---------------------------------------------------------------------------
...
loc_1A866:
		mov	byte_26718, 0B0h ; 'ｰ' ; jumptable 0001A854 case 15
		jmp	short loc_1A88A	; default
; ---------------------------------------------------------------------------
...
var_4		= dword	ptr -4
		...
		push	60007h
		push	ds
		push	offset aVrvsvVfvdb@vav
		push	0E1h
		call	text_putsa
		push	60009h
		push	ds
		push	offset aVovnvvvdvqb@bB
		push	0E1h
		call	text_putsa
		push	6000Bh
		push	ds
		push	offset aVcvqvdvVlb@vav
		push	0E1h
		call	text_putsa
		push	6000Dh
		push	ds
		push	offset aGjgxgkterfb@bB
		push	0E1h
		call	text_putsa
		push	60010h
		push	ds
		push	offset aVovnvhvmvsb@va
		push	0E1h
		call	text_putsa
		push	60015h
		push	ds
		push	offset aB@b@b@vsvnvsvV
		push	0E1h
		call	text_putsa
		push	60016h
		push	ds
		push	offset aB@b@b@b@b@vavp
		push	0C3h
		call	text_putsa
		les	bx, dword_2CDC6
		mov	al, es:[bx+11h]
...
var_4		= dword	ptr -4
		...
		push	60006h
		push	ds
		push	offset aVVkvkb@vbvmvev
		push	0E1h
		call	text_putsa
		push	60008h
		push	ds
		push	offset aVovnvvvdvqb@_0
		push	0E1h
		call	text_putsa
		push	6000Ah
		push	ds
		push	offset aVcvqvdvVlb@v_0
		push	0E1h
		call	text_putsa
		push	6000Ch
		push	ds
		push	offset aGjgxgkterfb@_0
		push	0E1h
		call	text_putsa
		cmp	byte_25688, 4
		jz	short loc_1D918
...
loc_1D922:
		...
		push	60011h
		push	ds
		push	offset aVovnvhvmvsb@_0
		push	0E1h
		call	text_putsa
		push	60015h
		push	ds
		push	offset aB@b@b@vsvnvs_0
		push	0E1h
		call	text_putsa
		mov	si, 3E8h
		movzx	eax, si
...
off_22EF8	dd asc_22F6A
					; "					  "...
STAGE_TITLE		dd aMCB@bPhantomLa	; "幻野　～ Phantom Land "
		dd aMCsb@bPhantomN	; "幻夜　～ Phantom Night"
		dd aMKib@bLakeOfBl	; "枯渇　～ Lake of Blood"
		dd aCChb@bDarkness	; "冥幽　～ Darkness "
		dd aCMB@bDreamOfFr	; "夢幻　～ Dream of Frail Girl"
		dd aMSzb@bPhantasm	; "幻想　～ Phantasmagoria "
		dd aTMvb@bRaspberr	; "追撃　～ Raspberry Trap "
		dd aVVVcvVvmnvRViv	; "すばらしい君に静かな暝りを　～ Puckish "...
BGM_TITLE		dd aWitchingDream	; "Witching Dream"
		dd aSeleneSLight	; "Selene's light"
		dd aSxp			; "装飾戦　～ Decoration Battle"
		dd aBreakTheSabbat	; "Break the Sabbath"
		dd aNglLB@bScarlet	; "紅響曲　～ Scarlet Phoneme"
		dd aBadApple		; "BAD Apple!!"
		dd aCRab@bPerditio	; "霊戦　～ Perdition crisis "
		dd aGagkgxgGggxgeg	; "アリスマエステラ"
		dd aRpvKab@bCasket	; "星の器　～ Casket of	Star "
		dd aLotusLove		; "Lotus Love"
		dd aCVVslXB@bSleep	; "眠れる恐怖　～ Sleeping Terror"
		dd aDreamLand		; "Dream Land"
		dd aChcB@bInanimat	; "幽夢　～ Inanimate Dream "
		dd aLVVVsv		; "禁じざるをえない遊戯	"
		dd aGbgcghmSzb@bIc	; "メイド幻想　～ Icemilk Magic	"
		dd aVivavvvvilcvb@	; "かわいい悪魔　～ Innocence"
		dd aPnpcuyszlB@bCa	; "少女綺想曲　～ Capriccio "
