...
loc_16B50:
		call	_randring2_next16_and	; jumptable 0001EA6B case 7819
		mov	[bp+var_1], al
		cmp	[bp+var_1], 0
		jnz	short loc_16B61
		mov	ax, (1 shl 4)
...
loc_201B4:
		call	_randring2_next16_and	; jumptable 0001F539 case 36296
		mov	byte_266E2, al
		push	(64 shl 4)
		call	_randring2_next16_mod
		mov	dx, _boss_pos.cur.x
