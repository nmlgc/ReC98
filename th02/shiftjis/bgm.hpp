...
// Music Room.
//
// This branch removes the original trailing whitespace from these strings to
// save a bit of binary size. The /**/ comments indicate the visual end of the
// string when shown; strings can be extended up to a length where the closing
// quote (") falls on the first /.
...
#define TH02_QT "   　　Ｑｕｉｔ"        /**/ // ZUN quirk: Not quite centered.
