...
void pascal cdg_put_nocolors_8(screen_x_t left, vram_y_t top, int slot);
	...
	// mode.
	//
	// This is used for the "dissolution effect" in the staff roll. It
	// actually doesn't apply any sort of effect on the pixel data though,
	// and relies on the individual planes being pre-dissolved.)
