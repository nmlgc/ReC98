...
// memory since the start of the stage (i.e., the player character faceset),
// freeing any images that aren't used during a dialog (i.e., the bomb
// background) in exchange for the necessary conventional memory.
...
// conventional memory.
// Apparently, this was also the most convenient place to load the boss faceset
// used for both the Mugetsu defeat / Gengetsu entrance dialog and the Gengetsu
// defeat dialogue? To differentiate between those two, the function tracks how
// often it has been called during the Extra Stage.
