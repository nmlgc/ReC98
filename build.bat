...
xcopy /-I /L /D /Y      .git\HEAD obj\fork.h | findstr /B /C:"1 " >NUL || ^
xcopy /-I /L /D /Y .git\refs\tags obj\fork.h | findstr /B /C:"1 " >NUL || ^
xcopy /-I /L /D /Y             %0 obj\fork.h | findstr /B /C:"1 " >NUL
...
:fork_write
 >obj\fork.h echo // Generated by %0.
>>obj\fork.h echo #define FORK_TAG    %FORK_TAG%
>>obj\fork.h echo #define FORK_DATE   %FORK_DATE%
>>obj\fork.h echo #define FORK_CREDIT %FORK_CREDIT%
:: ---------------
:fork_done
