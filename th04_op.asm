...
var_2		= word ptr -2
		...
		push	0Fh
		push	ds
		push	offset aB@b@b@b@b@ogcp ; "@@@@@g—p‚·‚é‰¹Œ¹‚ğ‘I‘ğ‚µ‚Ä‰º‚³‚¢‚"...
		call	far ptr	loc_DEB4
		mov	word_11E88, 0Ah
		mov	word_11E8A, 4
		push	large 200080h
...
var_2		= word ptr -2
		...
		push	0Fh
		push	ds
		push	offset aB@b@b@b@m ; "@@@@Œø‰Ê‰¹‚Ég—p‚·‚é‰¹Œ¹‚ğ‘I‘ğ‚µ‚Ä‚"...
		call	far ptr	loc_DEB4
		mov	word_11E88, 0Ah
		mov	word_11E8A, 4
		push	large 200080h
...
sub_D595	proc near
		...
		push	3
		push	ds
		push	offset aGtgugegfgGuvSi ; "ƒTƒuƒEƒFƒ|ƒ“‚Ì‘I‘ğ"
		call	far ptr	loc_DEB4
		pop	di
		pop	si
		pop	bp
...
byte_F3DC	db 0
					; sub_AE96+19Cw ...
byte_F3DD	db 1
		dd aGqbGav		; "ƒQ[ƒ€‚ğŠJn‚µ‚Ü‚·"
		dd aGgglgxgggigxge	; "ƒGƒLƒXƒgƒ‰ƒXƒe[ƒW‚ğŠJn‚µ‚Ü‚·"
		dd aMNVGngcgxgrgav	; "Œ»İ‚ÌƒnƒCƒXƒRƒA‚ğ•\\¦‚µ‚Ü‚·"
		dd aIKyoVU		; "‰¹Šyº‚É“ü‚è‚Ü‚·"
		dd aKeoarTsv		; "Šeíİ’è‚ğ•ÏXo—ˆ‚Ü‚·"
		dd aVcvnvrvCVsvV	; "‚c‚n‚r‚É–ß‚è‚Ü‚·"
		dd aUqiUxv		; "“ïˆÕ“x‚ğ‚â‚³‚µ‚­‚µ‚Ü‚·@i‰SÒŒü‚¯A‚"...
		dd aUqiUxv_1		; "“ïˆÕ“x‚ğ•W€‚É‚µ‚Ü‚·@@@iˆê”ÊŒü‚¯A‘"...
		dd aUqiUxv_0		; "“ïˆÕ“x‚ğ“ï‚µ‚­‚µ‚Ü‚·@@@iƒA[ƒP[ƒ_"...
		dd aUqiUxv_2		; "“ïˆÕ“x‚ğ”ñí‚É“ï‚µ‚­‚µ‚Ü‚·@iƒVƒ…[ƒ^"...
		dd aGqbGagxgBGgouv	; "ƒQ[ƒ€ƒXƒ^[ƒg‚Ìl”‚ğ•ÏXo—ˆ‚Ü‚·i"...
		dd aGGavOgcpi		; "ƒ{ƒ€‚Ìg—p‰ñ”‚ğ•ÏXo—ˆ‚Ü‚·iœ‚­ƒGƒLƒ"...
		dd aVavfvlvCmvVVV	; "‚a‚f‚l‚Í—¬‚ê‚Ü‚¹‚ñ"
		dd aVavfvlvVqvuvji	; "‚a‚f‚l‚É‚Q‚U‚j‰¹Œ¹ŒİŠ·‚ğg—p‚µ‚Ü‚·"
		dd aVavfvlvVwvuiMM	; "‚a‚f‚l‚É‚W‚U‰¹Œ¹ŒİŠ·‚ğg—p‚µ‚Ü‚·"
		dd aM_0			; "Œø‰Ê‰¹‚Í—¬‚ê‚Ü‚¹‚ñ"
		dd aM_2			; "Œø‰Ê‰¹‚É‚e‚l‰¹Œ¹‚ğg—p‚µ‚Ü‚·"
		dd aM_1			; "Œø‰Ê‰¹‚É‚a‚…‚…‚‰¹Œ¹‚ğg—p‚µ‚Ü‚·"
		dd aUgtevSVvpPkvBa	; "“G’e‚Ì‘½‚¢êŠ‚ÅA‚í‚´‚Æˆ——‚¿iƒXƒ"...
		dd aPicacovV		; "ˆ——‚¿‚ğƒ}ƒVƒ“‚ÌƒXƒs[ƒh‚É”C‚¹‚Ü‚·i•"...
		dd aVVGigvgvgzguv	; "‚±‚ÌƒIƒvƒVƒ‡ƒ“‚ğ‘S‚Ä•W€‚É–ß‚µ‚Ü‚·"
		dd aGigvgvgzguv		; "ƒIƒvƒVƒ‡ƒ“‚ğI—¹‚µ‚Ü‚·"
		dd aGqbGav_0		; "ƒQ[ƒ€‚ğŠJn‚µ‚Ü‚·iƒC[ƒW[j"
		dd aGqbGav_1		; "ƒQ[ƒ€‚ğŠJn‚µ‚Ü‚·iƒm[ƒ}ƒ‹j"
		dd aGqbGav_2		; "ƒQ[ƒ€‚ğŠJn‚µ‚Ü‚·iƒn[ƒhj"
		dd aGqbGav_3		; "ƒQ[ƒ€‚ğŠJn‚µ‚Ü‚·iƒ‹ƒiƒeƒBƒbƒNj"
byte_F446	db 0
byte_F447	db 0
...
; char path[]
path		db 'deb',0
aGqbGav		db 'ƒQ[ƒ€‚ğŠJn‚µ‚Ü‚·',0
aGgglgxgggigxge	db 'ƒGƒLƒXƒgƒ‰ƒXƒe[ƒW‚ğŠJn‚µ‚Ü‚·',0
aMNVGngcgxgrgav	db 'Œ»İ‚ÌƒnƒCƒXƒRƒA‚ğ•\¦‚µ‚Ü‚·',0
aIKyoVU		db '‰¹Šyº‚É“ü‚è‚Ü‚·',0
aKeoarTsv	db 'Šeíİ’è‚ğ•ÏXo—ˆ‚Ü‚·',0
...
aVavfvlvVqvuvji	db '‚a‚f‚l‚É‚Q‚U‚j‰¹Œ¹ŒİŠ·‚ğg—p‚µ‚Ü‚·',0
aVavfvlvVwvuiMM	db '‚a‚f‚l‚É‚W‚U‰¹Œ¹ŒİŠ·‚ğg—p‚µ‚Ü‚·',0
aM_0		db 'Œø‰Ê‰¹‚Í—¬‚ê‚Ü‚¹‚ñ',0
aM_2		db 'Œø‰Ê‰¹‚É‚e‚l‰¹Œ¹‚ğg—p‚µ‚Ü‚·',0
aM_1		db 'Œø‰Ê‰¹‚É‚a‚…‚…‚‰¹Œ¹‚ğg—p‚µ‚Ü‚·',0
aUgtevSVvpPkvBa	db '“G’e‚Ì‘½‚¢êŠ‚ÅA‚í‚´‚Æˆ——‚¿iƒXƒ[j‚³‚¹‚Ü‚·i‰SÒ—pj',0
aPicacovV	db 'ˆ——‚¿‚ğƒ}ƒVƒ“‚ÌƒXƒs[ƒh‚É”C‚¹‚Ü‚·i•W€j',0
aVVGigvgvgzguv	db '‚±‚ÌƒIƒvƒVƒ‡ƒ“‚ğ‘S‚Ä•W€‚É–ß‚µ‚Ü‚·',0
aGigvgvgzguv	db 'ƒIƒvƒVƒ‡ƒ“‚ğI—¹‚µ‚Ü‚·',0
aGqbGav_0	db 'ƒQ[ƒ€‚ğŠJn‚µ‚Ü‚·iƒC[ƒW[j',0
aGqbGav_1	db 'ƒQ[ƒ€‚ğŠJn‚µ‚Ü‚·iƒm[ƒ}ƒ‹j',0
aGqbGav_2	db 'ƒQ[ƒ€‚ğŠJn‚µ‚Ü‚·iƒn[ƒhj',0
aGqbGav_3	db 'ƒQ[ƒ€‚ğŠJn‚µ‚Ü‚·iƒ‹ƒiƒeƒBƒbƒNj',0
aOp1_pi		db 'op1.pi',0
					; sub_AE96+130o
aOp		db 'op',0
					; sub_B052+1B6o ...
...
byte_FD8A	db 0
		db    0
		dd aGxgegmgivevliM	; "ƒXƒeƒŒƒI‚e‚l‰¹Œ¹FPC-9801-86(ŒİŠ·)ƒ{[ƒ"...
		dd aB@b@b@b@b@b@b@	; "@@@@@@@@@CanBe“à‘ ‰¹Œ¹‚È‚ÇA  "...
		dd aB@b@b@b@b@b@_0	; "@@@@@@@‚e‚l‚U‰¹{‚r‚r‚f‚R‰¹{ƒŠƒ"...
		dd aB@xwpavevliMBf	; "@•W€‚e‚l‰¹Œ¹F  PC-9801-26K(ŒİŠ·)ƒ{["...
		...
		dd aB@vevliMB@bfm	; "@‚e‚l‰¹Œ¹@FŒø‰Ê‰¹‚É‚e‚l‰¹Œ¹‚ğg—p‚µ‚"...
		dd aB@b@b@b@b@b@_2	; "@@@@@@@‚a‚f‚l‚ªƒXƒeƒŒƒI‚e‚l‰¹Œ¹"...
		dd aB@B@B@b@bixwpa	; "@ @ @@i•W€‚e‚l‰¹Œ¹‚Å‚ÍA3ch‚ğg—p"...
		dd aB@B@b@b@b@VVBa	; "@ @@@@ ‚Ì‚ÅA‚a‚f‚l‚ª³í‚É‚«‚¯‚È‚"...
		dd aVavevevriMBfm	; "‚a‚…‚…‚‰¹Œ¹FŒø‰Ê‰¹‚É‚a‚…‚…‚‰¹Œ¹‚ğg—"...
		dd aVevliMVkcVvpNz	; "		 ‚e‚l‰¹Œ¹‚ª–³‚¢ê‡g—p‚µ‚"...
...
aB@M		db '@ Œø‰Ê‰¹–³‚µ @',0
aB@b@b@b@b@ogcp	db '@@@@@g—p‚·‚é‰¹Œ¹‚ğ‘I‘ğ‚µ‚Ä‰º‚³‚¢‚Ë™',0
aB@b@b@b@m	db '@@@@Œø‰Ê‰¹‚Ég—p‚·‚é‰¹Œ¹‚ğ‘I‘ğ‚µ‚Ä‚Ë™',0
...
aZun03_bft	db 'zun03.bft',0
		...
		dd aNo_16LVVVsv		; "No.16     ‹Ö‚¶‚´‚é‚ğ‚¦‚È‚¢—V‹Y    "
...
aNo_16LVVVsv	db 'No.16     ‹Ö‚¶‚´‚é‚ğ‚¦‚È‚¢—V‹Y    ',0
...
aOp1_pi_1	db 'op1.pi',0
		db    0
		dd aB@focasCBiiPcv	; "@”—íèË–²i›Ş—‚³‚ñj "
		dd aNlfINumvmB@		; "	L”ÍˆÍUŒ‚Œ^@	  "
		dd aCIjcvcanBicvc@	; " –¶‰J–‚—¹i–‚–@g‚¢j"
		dd aNumvcPdolm		; "	UŒ‚—Íd‹Œ^	  "
...
aB@focasCBiiPcv	db '@”—íèË–²i›Ş—‚³‚ñj ',0
aNlfINumvmB@	db '     L”ÍˆÍUŒ‚Œ^@    ',0
aCIjcvcanBicvc@	db ' –¶‰J–‚—¹i–‚–@g‚¢j',0
aNumvcPdolm	db '     UŒ‚—Íd‹Œ^      ',0
...
aStar		db '™',0
aGtgugegfgGuvSi	db 'ƒTƒuƒEƒFƒ|ƒ“‚Ì‘I‘ğ',0
