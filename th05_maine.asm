...
loc_B5EF:
		mov	bx, [bp+var_2]
		imul	bx, 9
		mov	byte ptr [bx+si+4F1Eh],	0C4h ; 'ƒ'
		inc	si
...
loc_BFEB:
		...
		mov	al, [bp+var_8]
		mov	[si+12h], al
		cmp	byte ptr [si+13h], 80h ; 'Ä'
		jnb	loc_C0CC
		jmp	short loc_C089
; ---------------------------------------------------------------------------

loc_C035:
		cmp	[bp+var_7], 0F0h ; 'ÅE
		jbe	short loc_C04C
		mov	[bp+var_7], 1
		cmp	byte ptr [si+13h], 80h ; 'Ä'
		jnb	short loc_C06F
...
var_2		= word ptr -2
		...
		push	word_116E4
		push	ds
		push	offset aNPiuU__0 ; "ç≈èIìæì_"
		call	far ptr	loc_E914
		mov	ax, word_116E2
		add	ax, 80h	; 'Ä'
		mov	[bp+var_2], ax
...
aKaikidan1_dat	db 'âˆ„Yík1.dat',0
aMiko		db 'miko',0
; char arg0[]
arg0		db 'op',0
		db    0
...
aUde_pi		db 'ude.pi',0
aB@vpcB@	db 'Å@ÇPñ Å@',0
aB@vqcB@	db 'Å@ÇQñ Å@',0
aB@vrcB@	db 'Å@ÇRñ Å@',0
aB@vscB@	db 'Å@ÇSñ Å@',0
aB@vtcB@	db 'Å@ÇTñ Å@',0
aB@vucB@	db 'Å@ÇUñ Å@',0
aNPiuU__0	db 'ç≈èIìæì_',0
byte_1183A	db 0
					; sub_D8F5+33r	...
		db 0
word_1183C	dw 0
